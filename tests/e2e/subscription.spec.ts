...
test.describe("Subscription on Organization page", () => {
  ...
  test("Should show “Subscribe” button when user reaches free plan limit", async ({
                                                                                  authenticatedPage,
                                                                                  testContext,
                                                                                  testPrisma
                                                                                }) => {
  ...
  test("Should show “Cancel Subscription” button when user has an active subscription", async ({
                                                                           authenticatedPage,
                                                                           testContext,
                                                                           testPrisma
                                                                         }) => {
    ...
    // Update subscription data cancel
